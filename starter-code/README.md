# Starter Code — Lab #3 (Student Workspace)
...
## 🚀 Cách Bắt Đầu
1. Mở file `template.py`.
2. Đọc hướng dẫn trong `../student_guide.md`.
3. Hoàn thiện các mục TODO trong class `ChatbotBaseline` và `ReActAgent`.
4. Chạy `python template.py` để kiểm tra kết quả console.
